...
import com.ott.ottapplication.models.Movies

object CustomData {


//    fun loadData(): ArrayList<Videos> {
//
//        var data: ArrayList<Videos> = ArrayList()
//
//        data.apply {
//            add(
//                Videos(
...
//                    arrayOf("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"),
//                    "By Blender Foundation",
...
//            add(
//                Videos(
//                    "Introducing Chromecast. The easiest way to enjoy online video and music on your TV—for.",
//                    "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4",
//                    "By Google",
//                    "images/ForBiggerMeltdowns.jpg",
...
//    }
    ...
    fun getData(): Movies {
        ...
        val gson = Gson()
        val movieContent = gson.fromJson(jsonString, Movies::class.java)
        return movieContent
    }
